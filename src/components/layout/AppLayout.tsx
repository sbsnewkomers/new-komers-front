        ...
        <div className="fixed inset-0 z-50 flex md:hidden">
          ...
          <div className="relative z-10 flex h-full w-[260px] flex-col bg-white border-r border-slate-100 shadow-xl">
            ...
            <div className="flex items-center justify-between px-4 py-4 border-b border-slate-100">
              ...
              <Link href="/" className="flex items-center gap-2 min-w-0 flex-1" onClick={() => setMobileMenuOpen(false)}>

                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary text-white shadow-sm flex-shrink-0">
