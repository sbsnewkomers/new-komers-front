...
export default function LandingPage() {
  ...
  return (
    <div className="landing min-h-screen selection:bg-[#64FFDA]/30">
      ...
      <header className="fixed top-0 w-full z-50 bg-black border-b border-[var(--border)]">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[var(--accent)] rounded-xl flex items-center justify-center">
              <span className="material-symbols-outlined text-[var(--primary)] font-bold">query_stats</span>
            </div>
            <span className="text-2xl font-bold tracking-tighter text-white">NEWKOMERS</span>
          </Link>
          <nav className="hidden lg:flex items-center gap-10">
            <a className="text-sm font-medium text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors" href="#features">Solutions</a>
            <a className="text-sm font-medium text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors" href="#social">Clientèle</a>
            <a className="text-sm font-medium text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors" href="#pricing">Tarification</a>
            <a className="text-sm font-medium text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors" href="#contact">Contact</a>
          </nav>
          <div className="flex items-center gap-6">
            {user ? (
              <>
                <Link className="text-sm font-medium text-[var(--text-muted)] hover:text-white transition-colors" href="/dashboard">Espace client</Link>
                <button
                  type="button"
                  onClick={() => logout()}
                  className="text-sm font-semibold bg-white text-[var(--primary)] px-6 py-2.5 rounded-full hover:bg-[var(--accent)] transition-all"
                >
                  Déconnexion
                </button>
              </>
              ...
              <>
                <Link className="text-sm font-medium text-[var(--text-muted)] hover:text-white transition-colors" href="/login">Se connecter</Link>
                <Link className="text-sm font-semibold bg-white text-[var(--primary)] px-6 py-2.5 rounded-full hover:bg-[var(--accent)] transition-all" href="/login">
                  Démarrer l&apos;essai
                </Link>
              </>
            )}
      ...
      <main className="relative overflow-hidden">
        <section className="relative pt-44 pb-32 px-6 gradient-bg">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full glass-panel border-[var(--border)] mb-10">
              <span className="flex h-2 w-2 rounded-full bg-[var(--accent)]"></span>
              <span className="text-xs font-semibold uppercase tracking-widest text-[var(--accent)]">Standard de Reporting Financier 2.0</span>
            </div>
            <h1 className="serif-heading text-5xl md:text-7xl font-bold text-white mb-8 max-w-5xl mx-auto leading-tight">
              La clarté financière absolue pour les <span className="italic text-[var(--accent)]">holdings & groupes</span>.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-24">
              <Link
                ...
                className="w-full sm:w-auto px-10 py-5 bg-[var(--accent)] text-[var(--primary)] font-bold rounded-xl hover:scale-105 transition-all shadow-xl shadow-[var(--accent)]/10 text-center"
              >
            ...
            <div className="relative max-w-6xl mx-auto group">
              <div className="absolute -inset-4 bg-gradient-to-tr from-[var(--accent)]/20 to-indigo-500/20 rounded-[40px] blur-3xl opacity-30 group-hover:opacity-50 transition-opacity"></div>
              <div className="relative glass-panel rounded-[32px] p-2 border border-white/10 shadow-2xl overflow-hidden">
                <div className="bg-[var(--primary)] rounded-[30px] overflow-hidden border border-white/5">
                  <div className="h-14 border-b border-white/5 bg-[var(--primary-light)] flex items-center px-6 gap-4">
                    ...
                    <div className="flex-1 max-w-md mx-auto">
                      <div className="bg-[var(--primary)] border border-white/5 rounded-lg h-7 flex items-center px-3 gap-2">
                        <span className="material-symbols-outlined text-[14px] text-[var(--text-muted)]">lock</span>
                        <span className="text-[10px] text-[var(--text-muted)] tracking-wide">newkomers.app/consolidated-dashboard</span>
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-12 h-[600px]">
                    <aside className="col-span-2 border-r border-white/5 p-6 space-y-8">
                      ...
                      <div className="space-y-4 pt-10">
                        <div className="h-2 w-full bg-[var(--accent)]/20 rounded"></div>
                    ...
                    <div className="col-span-10 p-8">
                      <div className="grid grid-cols-3 gap-6 mb-8">
                        <div className="h-32 bg-[var(--primary-light)] rounded-2xl border border-white/5 p-4">
                          <div className="w-8 h-8 rounded bg-[var(--accent)]/10 mb-4"></div>
                      ...
                      <div className="h-[340px] bg-[var(--primary-light)] rounded-2xl border border-white/5 relative overflow-hidden">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[var(--primary-light)] to-transparent"></div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-24 border-y border-[var(--border)] bg-[var(--primary-light)]/30" id="social">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col items-center gap-12">
              <div className="flex items-center gap-4">
                <div className="h-px w-12 bg-[var(--border)]"></div>
                <span className="text-xs font-bold uppercase tracking-[0.3em] text-[var(--text-muted)]">Approuvé par l&apos;élite financière</span>
                <div className="h-px w-12 bg-[var(--border)]"></div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-20 items-center mb-32">
              <div className="space-y-8">
                <div className="w-14 h-14 rounded-2xl bg-[var(--accent-soft)] border border-[var(--accent)]/20 flex items-center justify-center text-[var(--accent)]">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-3 text-sm text-white/80">
                    <span className="material-symbols-outlined text-[var(--accent)] text-xl">check_circle</span>
              ...
              <div className="feature-ui-card rounded-3xl p-8 shadow-2xl relative">
                <div className="space-y-4">
                  ...
                  <div className="h-40 w-full bg-white/5 rounded-xl border border-white/5 flex items-end p-4 gap-2">
                    <div className="flex-1 bg-[var(--accent)]/40 rounded-t h-[30%]"></div>
                    <div className="flex-1 bg-[var(--accent)]/60 rounded-t h-[50%]"></div>
                    <div className="flex-1 bg-[var(--accent)]/80 rounded-t h-[80%]"></div>
                    <div className="flex-1 bg-[var(--accent)] rounded-t h-[60%]"></div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden">
                      <div className="h-full w-[70%] bg-[var(--accent)]"></div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center text-xs text-white/40 uppercase tracking-widest">
        ...
        <section className="py-32 bg-[var(--primary-light)]/20" id="pricing">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-24">
              <span className="text-[var(--accent)] font-bold tracking-[0.2em] text-xs uppercase mb-4 block">Tarification Transparente</span>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="pricing-card glass-panel rounded-3xl p-10 flex flex-col">
                <div className="mb-10">
                  ...
                  <p className="text-sm text-[var(--text-muted)] mt-4">Idéal pour les jeunes groupes en croissance.</p>
                </div>
                <ul className="space-y-5 mb-12 flex-1">
                  <li className="flex items-center gap-3 text-sm">
                    <span className="material-symbols-outlined text-[var(--accent)] text-lg">done</span>
              ...
              <div className="pricing-card bg-[var(--primary-light)] border-2 border-[var(--accent)] rounded-3xl p-10 flex flex-col relative">
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[var(--accent)] text-[var(--primary)] px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wider">Recommandé</div>
                <div className="mb-10">
                  ...
                  <p className="text-sm text-[var(--text-muted)] mt-4">La puissance de la consolidation automatique.</p>
                </div>
                <ul className="space-y-5 mb-12 flex-1">
                ...
                <Link href="/login" className="w-full py-4 rounded-xl bg-[var(--accent)] text-[var(--primary)] font-bold hover:scale-[1.02] transition-all text-center block">
                  Démarrer Business
                </Link>
              </div>
              <div className="pricing-card glass-panel rounded-3xl p-10 flex flex-col">
                <div className="mb-10">
                  ...
                  <p className="text-sm text-[var(--text-muted)] mt-4">Pour les ETI et directions financières exigeantes.</p>
                </div>
                <ul className="space-y-5 mb-12 flex-1">
                  <li className="flex items-center gap-3 text-sm">
                    <span className="material-symbols-outlined text-[var(--accent)] text-lg">done</span>
        ...
        <section className="py-32 max-w-7xl mx-auto px-6" id="contact">
          <div className="relative bg-gradient-to-br from-indigo-900 to-[var(--primary)] rounded-[40px] p-12 md:p-24 text-center overflow-hidden border border-white/10 shadow-2xl">
            <div className="absolute -top-24 -right-24 w-96 h-96 bg-[var(--accent)]/10 blur-[100px] rounded-full"></div>
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Link href={user ? "/dashboard" : "/login"} className="px-12 py-5 bg-white text-[var(--primary)] font-bold rounded-2xl hover:bg-[var(--accent)] transition-all inline-block">
                  Déployer NEWKOMERS
                </Link>
      ...
      <footer className="bg-[var(--primary)] border-t border-[var(--border)] pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-16 mb-24">
            <div className="col-span-2">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-8 h-8 bg-[var(--accent)] rounded-lg flex items-center justify-center">
                  <span className="material-symbols-outlined text-[var(--primary)] text-sm font-bold">query_stats</span>
                </div>
                <span className="text-xl font-bold tracking-tight text-white">NEWKOMERS</span>
              </div>
              <p className="text-[var(--text-muted)] max-w-xs mb-8 leading-relaxed">
              ...
              <p className="text-[var(--text-muted)] text-xs flex items-center gap-2">
                <span className="material-symbols-outlined text-sm text-[var(--accent)]">lock</span>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-[var(--text-muted)]">
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#features">Consolidation</a></li>
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#features">Reporting Automatique</a></li>
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#features">Cash Burn Engine</a></li>
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#contact">Sécurité</a></li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold text-white mb-6 uppercase tracking-widest text-xs">Légal</h5>
              <ul className="space-y-4 text-sm text-[var(--text-muted)]">
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#">Confidentialité</a></li>
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#">Mentions Légales</a></li>
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#">CGU / CGV</a></li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold text-white mb-6 uppercase tracking-widest text-xs">Support</h5>
              <ul className="space-y-4 text-sm text-[var(--text-muted)]">
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#contact">Centre d&apos;aide</a></li>
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#">API Documentation</a></li>
                <li><a className="hover:text-[var(--accent)] transition-colors" href="#contact">Contact</a></li>
              </ul>
            </div>
          </div>
